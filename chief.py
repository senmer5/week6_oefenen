...
if __name__ == "__main__":
    ...
    """
    Merkez Sınıf: Chief
	•	Chief, şemanın merkezi ve diğer sınıflarla bağlantı kuran bir ana sınıf gibi çalışır.
	•	TaskManagement, TaskEditing, ve TaskTracking sınıfları, Chief aracılığıyla entegre edilir.
